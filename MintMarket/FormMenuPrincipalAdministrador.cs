...
{
    public partial class FormMenuPrincipalAdministrador : Form
    {
        //Constructor
        public FormMenuPrincipalAdministrador()
        {
            InitializeComponent();
        ...
        private void btnListaClientes_Click(object sender, EventArgs e)
        {
            ...
            frm.txtid.Text = "12345678";
            frm.txtnombre.Text = "JESUS";
            frm.txtapellido.Text = "BELEÑO";
            frm.txtdireccion.Text = "CLL 14 #41-A";
            frm.txttelefono.Text = "3007896756";
            frm.textPass.Text = "****************";
            frm.ShowDialog();
         }
